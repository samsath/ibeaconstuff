...
/**
 * Listener for iBeacon com.easibeacon.protocol events
 * 
 * @author inakivazquez
 *
 */
public interface IBeaconListener {
	...
	/**
	 * Called to notify an error in the iBeacon com.easibeacon.protocol, probably due to the BluetoothAdapter
